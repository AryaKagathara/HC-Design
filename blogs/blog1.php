...
<head>
    ...
    <title>Hindustan Corportation About</title>
    ...
    <section class="header1 cid-rpRm0X7OFg" id="header004-19">
        <div class="container">
            <div class="row text-center">
                <a href="../index.php" class="mbr-text mb-0 mbr-fonts-style font-weight-bold font-1 display-5 text-black col-12">Click To Home</a>
            </div>
            <div class="row">
                <div class="col-lg-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 m-auto">
                    <img src="../assets/images/product/chain-link.png" title="Machine" />
                </div>
            </div>
            <div class="row mb-5">
