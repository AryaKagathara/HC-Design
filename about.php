        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="m-auto py-5 align-center">
                    <a class="btn-sm btn-success display-7 text-center" href="process.php">Our Process</a>
                </div>
            </div>
            <div class="align-center my-3">
                <blockquote class="blockquote text-center border border-none bg-transparent font-1">
