...
<head>
    ...
    <title>Hindustan Corportation Contact</title>
        ...
        <div class="row">
            <div class="col-sm-12 col-sm-12 col-lg-6">
                ...
                <div class="my-3">
                    <p class="text-black mbr-text mbr-black mbr-regular mbr-light mbr-fonts-style font-1">Feel Free to
                        get
                        in touch with us. We are always open to discussing business firms or oppurtinities to be part of
                        your visions. </p>
                </div>
                <div class="my-4">
            ...
            ?>
                ...
                <div class="my-4">
                    ...
                    <h5 class="shake">
                        <a class="mbr-text mb-0 mbr-fonts-style font-weight-bold font-1 text-black"
                            href="<?php echo "mailto:",$array['Phone1'] ?>">
                            <?php 
              echo $array['Phone1'];
            ?>
                        </a>
                        <br>
                        <a class="mbr-text mb-0 mbr-fonts-style font-weight-bold font-1 text-black"
                            href="<?php echo "mailto:",$array['Phone2'] ?>">
                            <?php 
              echo $array['Phone2'];
            ?>
                        </a>
